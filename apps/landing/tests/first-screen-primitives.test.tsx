...
/**
 * The two first-screen words DEV-026 added, in the state a reader who asked for
...
/**
 * [DEV-027] The three canvas words the reference's BEHAVIOUR needed — AS SERVED.
 ...
 */
describe("the pointer-reactive canvas words as served (DEV-027)", () => {
