...
import {
  ...
  PixelRain, OrbitText, CellField, ArcField, ParticleSphere,
  type PinnedTab,
...
export default function KitchenSink() {
  ...
  return (
    <main className="mx-auto max-w-content px-6 md:px-12">
      ...
      <Case n="23" name="CellField" rule="Клітинки сітки загоряються під курсором і плавно згасають за ним (DEV-024). Лінії сітки малює CSS-фон, canvas — лише підсвічені клітинки на тому самому кроці. Не цикл: кадри йдуть, поки щось згасає, далі — спокій без жодного rAF. Лише pointer: fine; під reduced motion нічого не монтується.">
      ...
      <Case n="24" name="ArcField" rule="Віяло тонких дуг із центру блока; все віяло нахиляється до курсора й повертається, коли він іде (DEV-024). Не цикл: після доведення сцена спочиває. Під reduced motion і на тач-пристрої — нерухоме віяло. Маска arc-mask лишає центр під заголовок.">
