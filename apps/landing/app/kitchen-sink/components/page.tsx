  ...
  return (
    <TooltipProvider>
      <main className="mx-auto max-w-content px-6 md:px-12">
        ...
        <Case n="23" name="Stepper + Step" rule="План пілота як степпер (21st.dev Steppers), керований скролом: ScrollProgress публікує прогрес проходу 0 → 1 у --gp-progress, лінія заповнюється, точки спалахують на своїх порогах. Під reduced motion план одразу повний. Вертикальний — типовий.">
          <Stepper>
        ...
        <Case n="23b" name="Stepper direction=horizontal" rule="Той самий степпер лежачи — для сторінки, де план є довідкою, а не розповіддю (/pilot). Рейка існує лише там, де кроки стоять одним рядом (wide); нижче це список із волосяними лініями, без рейки й без точок. Напрям успадковується: Step його не приймає.">
