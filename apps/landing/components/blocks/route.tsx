...
/**
 * The route. [DEV-026] In the reference's form: a sticky list of the five steps
 ...
 *
 * Until DEV-026 this was Fora's pinned card stack (`ScrollStack`). The windows
 * and the copy are the same; only the composition changed, with the owner's
 * «1 в 1». `heading` is `h1` on /product, the page this block opens (DEV-025),
