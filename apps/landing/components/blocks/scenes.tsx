...
/**
 * The home page's product block. [DEV-023] In the reference's form: a two-tone
 ...
 * (DEV-022); the whole route is /product's sticky list.
 *
 * ONE `Reveal` PER CARD, not one `Stagger` round the three (R-02, and DEV-022's
