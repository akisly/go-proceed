...
/**
 * The home page's product block. [DEV-026] In the reference's form: a two-tone
 ...
 * (DEV-025); the whole route is /product's sticky list.
 *
 * ONE `Reveal` PER CARD, not one `Stagger` round the three (R-02, and DEV-025's
