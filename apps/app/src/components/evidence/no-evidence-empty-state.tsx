 ...
 *
 * `max-w-112`, NOT `max-w-md` — the same dash-theme container-namespace gap
 * `no-assignments-empty-state.tsx`'s own header documents in full and
 * `TODOS.md`'s "Surfaced by Plan D slice D0" P2 entry tracks as the real fix
 * (a missing container ROLE, not a fifth scattered substitution). Re-verified
 * for THIS route rather than assumed from that file's own check: this
 * route's own dash-owned CSS chunk (`static/chunks/`, named from this
