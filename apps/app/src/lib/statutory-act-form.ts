...
// The two §"Required disclaimers" texts that go under a requirement list live
// in `./required-disclaimers`, which the Telegram card and the office's
// blocked-reasons list import too (DEV-075, BL-156). Re-exported here so the
// act's tests and callers keep one import site.
export {
  DOVIDKOVYI_DISCLAIMER_TEXT, PROJECT_SOURCED_ITEMS_DISCLAIMER_TEXT,
  PROJECT_SOURCED_ITEMS_DISCLAIMER_PLACEMENT, type DisclaimerPlacement,
} from "./required-disclaimers";
