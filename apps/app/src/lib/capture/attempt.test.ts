...
/**
 * Fix round 2 on task 9: `AttemptGuard` is the extracted, pure decision the
 * round-1 review's own closing note said must not stay untested — the
 * JSX-local `discardedRef` boolean was exactly where the defect hid, because
 * nothing exercised the overlapping-attempt case in isolation from React.
 */
