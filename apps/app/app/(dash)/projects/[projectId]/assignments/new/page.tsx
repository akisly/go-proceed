...
/**
 * `/projects/{projectId}/assignments/new` — Plan D slice A.
 *
 ...
 * `ProjectPage` [`ProjectOverviewHeader` until DEV-035]'s own precedent one screen up
 * (`project-page.tsx`): a heading is shown for every branch that
...
export default async function NewAssignmentPage({ params }: NewAssignmentPageProps) {
  ...
  const back = `/projects/${projectId}/assignments/new`;
