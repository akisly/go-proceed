...
| C-006 | P1 | Legacy pilot assumes one legal entity. | `docs/legacy/19-organizations-roles-access.md` | Multi-own-entity workspace; own party selected on each contract. | Resolution approved | Pending |
...
| C-034 | P1 | The approved phrase “online mobile in v0.1” did not identify a native client or responsive-web delivery. | Legacy iOS/Android field-app intent; Task 3 product review | `apps/mobile` is an Expo/React Native iOS/Android client in v0.1; v0.3 adds offline capability to the same client. | Resolution approved | Pending |
