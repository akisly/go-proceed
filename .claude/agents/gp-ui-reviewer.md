---
name: "gp-ui-reviewer"
description: "Use when the coordinator assigns a finish-gate review of a GoProceed change under apps/landing, apps/app/app, apps/app/src/components, apps/mobile/src, packages/ui, packages/tokens or technical/copy-catalog.csv: review the diff, the pasted UI gate output and the harness screenshots against docs/design/02-building-ui.md, DESIGN.md and the role-pain map, and return PASS or HOLD."
