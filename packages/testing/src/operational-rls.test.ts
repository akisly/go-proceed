 ...
 * actor_scope alone, so the owner of A reads the record it wrote in A and the
 * owner of B, declaring A, reads only its own record of B. Membership is not
 * checked: a user whose membership ended keeps reading its own cached
 * responses until they expire (BL-103).
 *
