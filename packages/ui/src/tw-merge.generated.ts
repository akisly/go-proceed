...
export const COLOUR_NAMES = ["action", "action-fg", "action-ghost-hover", "action-hover", "action-signal", "action-signal-fg", "action-signal-hover", "brand", "canvas", "evidence-blocking", "evidence-pending", "evidence-satisfied", "focus", "ink", "ink-muted", "ink-secondary", "ink-subtle", "inverse", "line", "line-inverse", "line-strong", "line-subtle", "link", "on-inverse", "on-inverse-muted", "on-signal", "overlay", "signal", "status-attention", "status-attention-fg", "status-attention-line", "status-blocked", "status-blocked-fg", "status-blocked-line", "status-idle", "status-idle-fg", "status-idle-line", "status-ready", "status-ready-fg", "status-ready-line", "status-review", "status-review-fg", "status-review-line", "subtle", "sunken", "surface", "viz-1", "viz-2", "viz-3", "viz-4", "viz-5"] as const;
