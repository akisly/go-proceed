...
const TONE = {
   ...
   * [2026-09-22, DEV-027] It follows the ACCENT, which is pine now. It briefly
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {/* [2026-09-22, DEV-027] `text-ink-muted`, not `text-status-review-fg`.
  ...
  return (
    ...
    >
      <header className="grid gap-0.5 border-b border-line px-5 pb-3.5 pt-4">
        {/* The «now» eyebrow is the brand's accent, not the review state (DEV-027). */}
