...
| [ADR-007](ADR-007-pilot-field-client.md) | The pilot field client is a PWA | Approved | 2026-08-08 | 2026-09-03 | Amends ADR-004; amended by ADR-009 (2026-08-20) and ADR-011 decision 11 (2026-09-03); superseded in part by ADR-013 (2026-09-22: its PWA client and distribution decisions) |
...
| [ADR-009](ADR-009-three-pilot-surfaces.md) | Three pilot surfaces, separately deployed | Approved | 2026-08-20 | 2026-08-20 | Amends ADR-007 decision 1; superseded in part by ADR-013 (2026-09-22: its Expo-web deployment and delayed-retirement gate) |
...
| [ADR-014](ADR-014-revoke-access-and-end-responsibility.md) | Revoking project access and ending a responsibility in v0.1-M1 | Approved | 2026-09-23 | 2026-09-24 | Adds two operations and one table to v0.1 under ADR-006 replacement rule 1 and changes none of ADR-006's decisions; amended 2026-09-24 (a removal reports what it leaves live, DEV-050; what the last-administrator rule already covers, DEV-051; a grant's revoke is written once, DEV-052) |
| [ADR-015](ADR-015-stock-tailwind-under-the-tokens.md) | Stock Tailwind stays whole; the design tokens ride on top of it | Approved | 2026-09-24 | 2026-09-24 | Amends `docs/design/02-building-ui.md` §1 and §4.1 (the stock namespaces are no longer cleared) |
