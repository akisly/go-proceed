...
The owner decided these on 2026-09-24 (task [DEV-056](../tasks/DEV-056-field-client-decisions.md)). gp-architect and gp-mobile shaped the design. The approved spec's vault paragraph is corrected on the same date.
