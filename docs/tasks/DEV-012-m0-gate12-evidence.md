...
- **Owning module and allowed edit paths:** `docs/delivery/production-readiness.md` §12, `docs/delivery/pilot-execution-runbook.md` §5.12 and §5.14 row 3, §5.7 and §8.1 (DEV-011 notes), `docs/STATUS.md`, `docs/BACKLOG.md` (BL-079, BL-085, BL-088), this record and the index. No code or schema change; a gap the evidence shows becomes a backlog entry.
