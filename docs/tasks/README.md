...
| [DEV-024](DEV-024-invite-token-in-fragment.md) | verifying | BL-109: the invitation link carries its token in the fragment (`invite#<token>`), and a static test keeps secrets out of route paths and query strings |
