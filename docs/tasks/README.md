...
| [DEV-007](DEV-007-design-sources.md) | verifying | Design sources of truth: stale design memory files and duplicates removed with restore commands, reference folders labelled by standing, the rewrite plan Historical, `outputs/` described and reviewed for personal data |
