...
| [DEV-010](DEV-010-m0-gate14-evidence.md) | rework | Evidence toward M0 readiness gate 14 (runbook item 7): the deploy preflight and the key registry refuse unusable HMAC keys without printing them, a standalone secret rotation runbook, the `version-0.0.md` role-password tick; the gate stays open on BL-085 |
