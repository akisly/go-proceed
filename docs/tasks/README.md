...
| [DEV-075](DEV-075-requirement-list-disclaimers.md) | reviewing | BL-156: the Telegram card, the requirement-choice prompt and the office's blocked-reasons list print the довідковий disclaimer and, when an item is project-sourced, the project-sourced note; the texts have one source in `apps/app` |
