...
| [DEV-061](DEV-061-field-client-decisions.md) | verifying | The field client's open owner decisions: offline sign-out, a wipe for a vault that cannot open, reset after reinstall, a held discard, the requirement on the queue card, bounded discard waits |
