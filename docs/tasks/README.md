...
| [DEV-058](DEV-058-field-client-decisions.md) | reviewing | The field client's open owner decisions: offline sign-out, a wipe for a vault that cannot open, reset after reinstall, a held discard, the requirement on the queue card, bounded discard waits |
