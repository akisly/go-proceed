...
| [DEV-022](DEV-022-request-hash-target.md) | verifying | BL-112: a command's request hash binds its path target, so a key reused for another target is 409, not a replay of the first |
