...
| [DEV-010](DEV-010-m0-gate14-evidence.md) | reviewing | M0 readiness gate 14 (runbook item 7): the deploy preflight refuses malformed HMAC keys and an absent active key id, a standalone secret rotation runbook, the `version-0.0.md` role-password tick, and the dated gate 14 entry for the environments that exist |
