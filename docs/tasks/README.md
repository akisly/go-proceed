...
| [DEV-042](DEV-042-mobile-native.md) | implementing | Native iOS/Android field client, functional glass, pinned reference images and encrypted restart-safe capture queue; immediate web-field retirement |
