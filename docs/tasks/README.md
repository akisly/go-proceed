...
| [DEV-041](DEV-041-staging-migrations-0059-0094.md) | done | The hosted project reaches `0094` (36 migrations, `0059`–`0094`, pushed in four verified batches with the owner's approval) and the production build of `main` deploys with the purge variables; a cron run is still to be observed |
