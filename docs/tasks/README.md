...
| [DEV-009](DEV-009-m0-gate10-evidence.md) | reviewing | M0 readiness gate 10 (runbook items 9 and 10): the ДБН file and its retrieval record under `technical/requirements/`, the Реєстр будівельних норм check with its procedure, and the first dated gate evidence entry in `version-0.1.md` §M0 |
