...
| [DEV-046](DEV-046-android-vault.md) | verifying | The encrypted vault builds and runs on Android: pinned libsodium and the shared C core compiled per ABI, and the iOS vault hardening ported to Kotlin |
