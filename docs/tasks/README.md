...
| [DEV-006](DEV-006-freeze-todos.md) | verifying | Freeze of `TODOS.md` and the HANDOFF files (first-line banner, sha256 pins); live `TODOS.md` line citations re-pointed to backlog ids; validator guards against new line citations and for `docs/BACKLOG.md` against its preamble |
