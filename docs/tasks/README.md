...
| [DEV-021](DEV-021-invitation-revoke.md) | reviewing | BL-107: an owner or admin can revoke a pending invitation, and the create's conflict names the blocking one (ADR-012) |
