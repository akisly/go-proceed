...
| [DEV-023](DEV-023-idempotency-secret-guard.md) | reviewing | BL-108: `withIdempotency` refuses to store a body carrying a bearer secret (INV-102 enforced in the helper) |
