...
| [DEV-011](DEV-011-telegram-hmac-key-ids.md) | implementing | Key ids for the Telegram link-token and erasure-registry HMAC keys (BL-085), which readiness gate 14 waits on |
