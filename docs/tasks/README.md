...
| [DEV-012](DEV-012-m0-gate12-evidence.md) | implementing | Evidence toward M0 readiness gate 12 (runbook item 12): the built upload and import controls with their tests, and the owner's pilot malware decision with its risk; the gate stays open on export neutralization |
