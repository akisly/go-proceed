...
| [DEV-058](DEV-058-field-project-sourced-disclaimer.md) | verifying | BL-154: the field obligation list prints the project-sourced items disclaimer, only when an item is labelled «за робочою документацією об'єкта», immediately after the довідковий one; both mobile copies are held byte-equal to the content rules |
