...
| [DEV-017](DEV-017-capture-event-service-workspace.md) | verifying | BL-102: the service plane's capture event confined to the workspace it declares (migration `0087`) |
