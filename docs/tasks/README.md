...
| [DEV-013](DEV-013-m0-gate11-coverage-checker.md) | implementing | M0 readiness gate 11: a mechanical coverage checker for positive and negative tenant-isolation tests per exposed relation (INV-060) |
