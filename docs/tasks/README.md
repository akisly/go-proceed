...
| [DEV-008](DEV-008-types-react-dedupe.md) | verifying | Deterministic CI `typecheck`: one `@types/react` version in the lockfile (`apps/mobile` 19.2.4 → 19.2.18), since pnpm 9.12.0 privately hoists whichever copy the first-listed importer brings and that order varies between runs |
