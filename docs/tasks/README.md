...
| [DEV-062](DEV-062-validate-package-deleted.md) | implementing | BL-063: the orphaned `scripts/validate_package.py` is deleted (owner); what it asserted and what it found on its last possible run are recorded |
