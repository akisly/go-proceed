...
| `src/app/index.tsx` comment names the deleted `token-proof` route; `screens/token-proof.tsx` unused | gp-qa nit | Open: pre-existing DEV-042 web-retirement cleanup, outside rows 3–4 |
