...
| Database suites (`apps/app` integration, `packages/testing`, including the INV-108 probes) | Yes | d07c9136 (+ this change) | `packages/testing` 55 files / 827 PASS; `apps/app` 1442 PASS, 2 FAIL outside DEV-042 (fixed by #119); row 13 | PASS | Local stack; CI not run (Actions billing) |
