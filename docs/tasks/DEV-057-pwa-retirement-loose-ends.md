...
| 7 | Coordinator (closure) | Owner merged #125 as `599d337a` on 2026-09-24 (13:29 UTC); state `done` | `gh pr view 125` (MERGED) | — |
...
- Final state and reason: done — every required criterion PASS (gp-qa row); merged by the owner in #125 (`599d337a`, 2026-09-24).
