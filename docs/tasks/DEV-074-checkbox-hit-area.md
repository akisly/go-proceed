...
| U6 | minor | `Checkbox.tsx` (the U5 fix) | cancelling the END inset let the 2px + 2px focus ring reach the label text (touch, and case 13 at the desk) | Coordinator | Fixed: start-side margin only (`-ml-1 touch:-ml-3.5`); measured at 1920/1440/1240/768/390/360 on both kitchen-sink checkboxes: painted left = column left, ring clearance to the label's first glyph 4px (case 13) and 8px (case 14), hit 24×24 desk / 44×44 touch, checked fill `rgb(12, 12, 10)` (`shots3/measure-final.json`) |
