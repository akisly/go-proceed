...
| [BL-126](#bl-126) | P3 | open | The dashboard has no time series, so the reference's chart by month and its period picker have nothing to draw |
| [BL-127](#bl-127) | P3 | open | Dashboard follow-ups the DEV-035 UI review named and left out of scope |
| [BL-128](#bl-128) | P2 | open | Loose ends of the field PWA's retirement: apps/mobile's ported headers, its browser pass outside CI, dead icon assets, old `/a/{id}` links |
| [BL-129](#bl-129) | P2 | open | The field client's origin sends no security headers, and its session token is readable by script |
<!-- index:end -->
...
<a id="bl-126"></a>
### BL-126 — P3 — The dashboard has no time series, so the reference's chart by month and its period picker have nothing to draw
...
<a id="bl-127"></a>
### BL-127 — P3 — Dashboard follow-ups the DEV-035 UI review named and left out of scope
...
<a id="bl-128"></a>
### BL-128 — P2 — Loose ends of the field PWA's retirement: apps/mobile's ported headers, its browser pass outside CI, dead icon assets, old `/a/{id}` links
...
<a id="bl-129"></a>
### BL-129 — P2 — The field client's origin sends no security headers, and its session token is readable by script
