...
| [BL-158](#bl-158) | P3 | open | A sign-in within auth-js's pending-refresh window after an offline sign-out could still be overwritten by that refresh |
<!-- index:end -->
...
<a id="bl-158"></a>
### BL-158 — P3 — A sign-in within auth-js's pending-refresh window after an offline sign-out could still be overwritten by that refresh
