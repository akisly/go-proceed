...
| 3 | Item 12's built halves (readiness gate 12, uploads/imports) — **done 2026-09-15, [DEV-012](../tasks/DEV-012-m0-gate12-evidence.md): evidence and the malware acceptance; the gate waits on item 3 and BL-088** | **S** — writing | Same |
