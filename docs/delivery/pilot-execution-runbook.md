...
| C-12 | [TODOS.md](../../TODOS.md) (frozen), now [BL-045](../BACKLOG.md#bl-045) | «D1–D4 remain» → only D4 remains | Sprint ordering |
...
[BL-021](../BACKLOG.md#bl-021) (from [TODOS.md](../../TODOS.md)) records as revocable only by a superuser
`UPDATE`.
