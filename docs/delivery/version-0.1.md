...
2026-08-06 — **58 operations in v0.1**; **60 as of 2026-08-18**; **62 as of 2026-08-22**; **65 as of 2026-08-24**; **68 as of 2026-08-28**; **69 as of 2026-08-29**; **75 as of 2026-09-01**; **76 as of 2026-09-18**; **77 as of 2026-09-23** — see the notes under the table. The per-milestone operation ids are listed
...
*M1 is 37 operations as of 2026-09-23: `project_access.revoke` was added by [ADR-014](../decisions/ADR-014-revoke-access-and-end-responsibility.md) ([DEV-043](../tasks/DEV-043-project-access-revoke.md), BL-021), because a project access grant could be issued and never taken back, and a grant that lapsed blocked its capability for good. No new table.*
...
- **API slice:** the 37 `v0.1-M1` operations — `workspaces.create`,
  ...
  `project_access.grant`, `project_access.revoke`, `project_responsibilities.assign`, `contracts.create`,
  `contract_versions.create`, `work_items.create`, `work_items.update`,
